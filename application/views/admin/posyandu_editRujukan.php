<div class="app-main__outer">
    <div class="app-main__inner">
        ...
        <div class="card-header">
            <a href="<?php echo site_url('admin/posyandu/pasienRujukan') ?>"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
        <div class="card-body" style="background-color:#fff; color: black">
            <form action="<?php echo site_url('admin/posyandu/rujukan_edit_save/' . $pasienrujukan->id_rujukan) ?>" method="post">
                ...
                <!-- <div class="form-group">
                    ...
                    <input class="form-control <?php echo form_error('rumahsakit') ? 'is-invalid' : '' ?>" type="text"
                        name="rumahsakit" placeholder="Rumah Sakit Yang Dituju" value="<?=$pasienrujukan->rumahsakit;?>">
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control <?php echo form_error('tgl_pembuatan') ? 'is-invalid' : '' ?>"
                        type="date" name="tgl_pembuatan" placeholder="Tanggal Pembuatan Surat" value="<?=$pasienrujukan->tgl_pembuatan;?>">
                    <div class="invalid-feedback">
                        <?php echo form_error('tgl_pembuatan') ?>
                    </div>
                </div>
                <input type="hidden" name="rujukan_dari" value="Posyandu">
