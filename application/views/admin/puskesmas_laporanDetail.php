<div class="app-main__outer">
    <div class="app-main__inner">
        ...
        <div class="row">
            <div class="col-sm">
            <a href="<?=base_url('admin/puskesmas/laporanPuskesmas')?>" class="btn btn-danger mb-2"><i class="fas fa-arrow-left"></i> Kembali</a>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input class="form-control <?php echo form_error('nama') ? 'is-invalid' : '' ?>" type="text" name="nama" placeholder="Nama Lengkap" value="<?= $ibuhamil->nama; ?>" readonly />
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control <?php echo form_error('pekerjaan') ? 'is-invalid' : '' ?>" type="text" name="pekerjaan" placeholder="Pekerjaan" value="<?= $ibuhamil->pekerjaan; ?>" readonly />
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control <?php echo form_error('nama_suami') ? 'is-invalid' : '' ?>" type="text" name="nama_suami" placeholder="Nama Suami" value="<?= $ibuhamil->nama_suami; ?>" readonly>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control <?php echo form_error('pekerjaan_suami') ? 'is-invalid' : '' ?>" type="text" name="pekerjaan_suami" placeholder="Pekerjaan Suami" value="<?= $ibuhamil->pekerjaan_suami; ?>" readonly>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input class="form-control <?php echo form_error('umur') ? 'is-invalid' : '' ?>" type="number" name="umur" placeholder="Umur" value="<?= $ibuhamil->umur; ?>" readonly>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control <?php echo form_error('notelp') ? 'is-invalid' : '' ?>" type="text" name="notelp" placeholder="Nomor Telepon" value="<?= $ibuhamil->notelp; ?>" readonly>
                                    <div class="invalid-feedback">
        ...
        <div class="row">
            <div class="col-sm">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h1 class="h3 mb-2 text-gray-800">Data Rujukan Pasien</h1>
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                                <thead class="thead-dark">
                                    <tr>
