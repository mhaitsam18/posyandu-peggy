        ...
        <div class="row">
            <div class="col-sm">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <a href="<?php echo site_url('admin/posyandu/laporan') ?>"><i class="fas fa-arrow-left"></i> Back</a>
                            ...
                            <table class="table table-hover table-striped table-responsive" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    foreach ($rujukans as $row) : ?>
                                        <tr>
                                            <th scope="col"><?= $no++; ?></th>
                                            <td width="200"><?= $row->no_rujukan ?></td>
                                            <td width="200"><?= $row->puskesmas ?></td>
                                            <td width="200"><?= $row->rumahsakit ?></td>
                                            <td width="200"><?= $row->kab_kota ?></td>
                                            <td width="200"><?= $row->poli ?></td>
                                            <td width="200"><?= $row->namapasien ?></td>
                                            <td width="200"><?= $row->umur ?></td>
                                            <td width="200"><?= $row->alamat ?></td>
                                            <td width="200"><?= $row->nopasien ?></td>
                                            <td width="200"><?= $row->diagnosa ?></td>
                                            <td width="200"><?= date('d F Y', strtotime($row->tgl_pembuatan)) ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
...
<button onClick="window.print()">Print</button>
    <!-- </div> -->
<!-- <a href="<?php echo site_url('admin/posyandu/laporanDetail/' . $pasienrujukan->id_rujukan) ?>"
