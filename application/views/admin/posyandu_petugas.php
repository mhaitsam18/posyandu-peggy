<div class="app-main__outer">
    <div class="app-main__inner">
        ...
        <button type="button" class="btn mr-2 mb-2 btn-primary" data-toggle="modal"
            data-target="#modal-tambah-petugas"><i class="fas fa-plus"></i> Tambah Data Petugas</button> <?=$this->session->flashdata('pesan')?>
        <div class="row">
            <div class="col-sm">
                        ...
                        <table class="display" id="example">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning" href="<?php echo base_url('admin/posyandu/editPetugas/' . $value->id_petugas); ?>">Update</a>
                                        <a class="btn btn-danger" href="<?php echo base_url('admin/posyandu/deletePetugas/' . $value->id_petugas); ?>">Delete</a>
                                    </td>
                                </tr>
                                <?php }?>
                            </tbody>
