                        ...
                        <form class="" action="<?=base_url('admin/posyandu/add_data_pendaftar')?>" method="post">
                            <div class="card-body" style="background-color:#00b300; color: white">
                                <div class="container">
                                    ...
                                    <div class="col-sm-12">
                                                    <div class="form-group row">
                                                        <label for="ktp" class="col-sm-1 col-form-label" required>Nomor KTP Ibu</label>
                                                        <div class="col">
                                                            <input name="ktp" type="number" class="form-control" id="ktp" placeholder="Masukan Nomor KTP Ibu" required>
                                                        </div>
                                                    </div>
