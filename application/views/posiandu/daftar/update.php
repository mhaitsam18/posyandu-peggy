...
<?php $this->load->view('admin/_partials/breadcrumb');?>
	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="container">
                ...
                <div class="col-sm-12">
                                <div class="form-group row">
                                    <label for="ktp" class="col-sm-1 col-form-label">Nomor KTP Ibu</label>
                                    <div class="col">
                                        <input name="ktp" type="number" class="form-control" id="ktp" placeholder="Masukan Nomor KTP Ibu" value="<?php echo $pendaftaran->ktp?>">
                                    </div>
                            </div>
                            </div>
                        </div>
