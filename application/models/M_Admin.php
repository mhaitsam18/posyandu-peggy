...
class M_Admin extends CI_Model
{
    ...
    {
        $this->db->join('kategori_usia', 'pencatatan.kategori = kategori_usia.id_usia');
        $this->db->join('imunisasi', 'pencatatan.jenis_imunisasi = imunisasi.id_imunisasi');
        $this->db->join('regisanak', 'pencatatan.no_pasien = regisanak.no_pasien');
        $query = $this->db->get('pencatatan');
        return $query->result();
