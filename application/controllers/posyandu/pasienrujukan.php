...
class pasienrujukan extends CI_Controller
{
    ...
    {
        $data["pencatatan"] = $this->pasienrujukan_model->getrujuk($id);
        // $this->load->view('layout/posiandu/head.php');

        $this->load->view('posiandu/pasienrujukan/formtambah',$data);

        // $this->load->view('layout/foot.php');


    }
    public function tambah_pasienrujukan1()
    {
        $data["pencatatan"] = $this->pasienrujukan_model->get_by_role_pencatatanMedis();
        $data['showGraph'] = null;
        $this->load->view('layout/posiandu/head.php');
        $this->load->view("posiandu/pasienrujukan/tambah_pasienrujukan1", $data);
        $this->load->view('layout/foot.php');
    }
    ...
    {
        if (!isset($id)) {
            redirect('posyandu/pasienrujukan');
        }
    ...
    public function activate()
    {
        ...
        $print = $this->pasienrujukan_model->updateStatusRujuk($id, $status);
        $json_data = [
